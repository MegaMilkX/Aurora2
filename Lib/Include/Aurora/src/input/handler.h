...
// These correspond exactly to winapi virtual keys
enum KEYCODE
{
    ...
    KEY_OEM_SPEC0 = 0x92, // 0x92-96 OEM specific
    KEY_OEM_SPEC1,
    KEY_OEM_SPEC2,
    KEY_OEM_SPEC3,
    KEY_OEM_SPEC4,
    ...
    KEY_OEM_SPEC5 = 0xE1, // OEM specific
    KEY_OEM_102 = 0xE2, // Either the angle bracket key or the backslash key on the RT 102-key keyboard
    KEY_OEM_SPEC6 = 0xE3, // 0xE3-E4 OEM specific
    KEY_OEM_SPEC7,
    KEY_PROCESSKEY = 0xE5, // IME PROCESS key
    KEY_OEM_SPEC8 = 0xE6, // OEM specific
    KEY_PACKET = 0xE7, // Used to pass Unicode characters as if they were keystrokes. The VK_PACKET key is the low word of a 32-bit Virtual Key value used for non-keyboard input methods. For more information, see Remark in KEYBDINPUT, SendInput, WM_KEYDOWN, and WM_KEYUP
    KEY_OEM_SPEC9 = 0xE9, // 0xE9-F5 OEM specific
    KEY_OEM_SPEC10,
    KEY_OEM_SPEC11,
    KEY_OEM_SPEC12,
    KEY_OEM_SPEC13,
